...
# Ensure local scripts/ is importable when run as `python scripts/regenerate_all_figures.py`
sys.path.append(str(Path(__file__).parent))

from fig_manifest import FIGS
...
try:
    import create_remaining_improved_figures as create
except Exception as e:
    create = None
    print("[warn] create_remaining_improved_figures not importable:", e)
try:
    import verify_and_improve_figures as qa
except Exception as e:
    qa = None
